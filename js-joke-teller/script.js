...
// Passing joke to TTS API
function tellMe(joke){
    VoiceRSS.speech({
        key: '075598d1964f4298a0b89e32b5f64481',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
// make async function getJokes() to get data from jokesAPI
async function getJokes(){
    ...
    try {
        ...
        // text-to-speech
        tellMe(joke);
        // Disabled button while joke being read
        toggleButton();
    } catch (error) {
        console.log(error);
    }
